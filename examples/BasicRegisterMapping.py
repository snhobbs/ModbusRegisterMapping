...
if __name__ == "__main__":
    ...
    modbus_generator.MakeLibModbusTest(input_registers=GetInputRegisterMapEntries(), holding_registers=GetHoldingRegisterMapEntries(), includes=["HoldingRegisterMappedDataStore.h", "InputRegisterMappedDataStore.h"])
    modbus_generator.MakePyModbusTest(input_registers=GetInputRegisterMapEntries(), holding_registers=GetHoldingRegisterMapEntries(), includes=["HoldingRegisterMappedDataStore.h", "InputRegisterMappedDataStore.h"])
