 ...
 * Autogenerated file: 2020-12-31T18:00:07.118639
 */
...
class DataMap {
 ...
 public:
  ...
  ArrayView<const uint8_t> get_version(void) const {
    return ArrayView<const uint8_t>{64, GetDataBank().version};
  }
  void set_version(const uint8_t* const value, std::size_t length) {
    for (std::size_t i = 0; i < length; i++) {
      GetDataBank().version[i] = value[i];
    }
  }
  ArrayView<const uint8_t> get_firmware_version(void) const {
    return ArrayView<const uint8_t>{64, GetDataBank().firmware_version};
  }
  void set_firmware_version(const uint8_t* const value, std::size_t length) {
    for (std::size_t i = 0; i < length; i++) {
      GetDataBank().firmware_version[i] = value[i];
    }
  }
  ArrayView<const uint8_t> get_compile_date(void) const {
    return ArrayView<const uint8_t>{64, GetDataBank().compile_date};
  }
  void set_compile_date(const uint8_t* const value, std::size_t length) {
    for (std::size_t i = 0; i < length; i++) {
      GetDataBank().compile_date[i] = value[i];
    }
  }
  ArrayView<const uint8_t> get_compile_time(void) const {
    return ArrayView<const uint8_t>{64, GetDataBank().compile_time};
  }
  void set_compile_time(const uint8_t* const value, std::size_t length) {
    for (std::size_t i = 0; i < length; i++) {
      GetDataBank().compile_time[i] = value[i];
    }
  }
  ArrayView<const uint8_t> get_serial_number(void) const {
    return ArrayView<const uint8_t>{40, GetDataBank().serial_number};
  }
  void set_serial_number(const uint8_t* const value, std::size_t length) {
    for (std::size_t i = 0; i < length; i++) {
      GetDataBank().serial_number[i] = value[i];
    }
  }
  uint16_t get_fault_status(void) const { return GetDataBank().fault_status; }
  void set_fault_status(uint16_t value) { GetDataBank().fault_status = value; }
  int32_t get_p5_micro_volts(void) const {
    return GetDataBank().p5_micro_volts;
  }
  void set_p5_micro_volts(int32_t value) {
    GetDataBank().p5_micro_volts = value;
  }
  uint32_t get_p5_reading(void) const { return GetDataBank().p5_reading; }
  void set_p5_reading(uint32_t value) { GetDataBank().p5_reading = value; }
  int32_t get_p23_micro_volts(void) const {
    return GetDataBank().p23_micro_volts;
  }
  void set_p23_micro_volts(int32_t value) {
    GetDataBank().p23_micro_volts = value;
  }
  uint32_t get_p23_reading(void) const { return GetDataBank().p23_reading; }
  void set_p23_reading(uint32_t value) { GetDataBank().p23_reading = value; }
  int32_t get_vlo_micro_volts(void) const {
    return GetDataBank().vlo_micro_volts;
  }
  void set_vlo_micro_volts(int32_t value) {
    GetDataBank().vlo_micro_volts = value;
  }
  uint32_t get_vlo_reading(void) const { return GetDataBank().vlo_reading; }
  void set_vlo_reading(uint32_t value) { GetDataBank().vlo_reading = value; }
  int32_t get_thermistor_temp_spi(void) const {
    return GetDataBank().thermistor_temp_spi;
  }
  void set_thermistor_temp_spi(int32_t value) {
    GetDataBank().thermistor_temp_spi = value;
  }
  int32_t get_thermistor_temp_mcu(void) const {
    return GetDataBank().thermistor_temp_mcu;
  }
  void set_thermistor_temp_mcu(int32_t value) {
    GetDataBank().thermistor_temp_mcu = value;
  }
  uint32_t get_data_frequency(void) const {
    return GetDataBank().data_frequency;
  }
  void set_data_frequency(uint32_t value) {
    GetDataBank().data_frequency = value;
  }
  int32_t get_p3_3_micro_volts(void) const {
    return GetDataBank().p3_3_micro_volts;
  }
  void set_p3_3_micro_volts(int32_t value) {
    GetDataBank().p3_3_micro_volts = value;
  }
  uint32_t get_p3_3_reading(void) const { return GetDataBank().p3_3_reading; }
  void set_p3_3_reading(uint32_t value) { GetDataBank().p3_3_reading = value; }
